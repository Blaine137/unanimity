...
export let handleUsersChatRoomsID = () => {
...
export let handleCurrentChatRoomName = ChatRoomID => {   
	if(ChatRoomID) {
...
export let handleCurrentChatRoom = setChatRoomID => { 
...
export let newChatRoom = (event, recipentName) => {
...
export let removeChatRoom = removeChatRoomID => {
